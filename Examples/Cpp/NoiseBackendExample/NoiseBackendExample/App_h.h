...
#ifndef ____x_NoiseBackendExample_CIApp_FWD_DEFINED__
#define ____x_NoiseBackendExample_CIApp_FWD_DEFINED__

namespace NoiseBackendExample {
    interface IApp;
} /* NoiseBackendExample */
#define __x_NoiseBackendExample_CIApp NoiseBackendExample::IApp

#endif // ____x_NoiseBackendExample_CIApp_FWD_DEFINED__
...
/*
 *
 * Interface NoiseBackendExample.IApp
 *
 * Interface is a part of the implementation of type NoiseBackendExample.App
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: NoiseBackendExample.IApp:
 *
 *
 */
#if !defined(____x_NoiseBackendExample_CIApp_INTERFACE_DEFINED__)
#define ____x_NoiseBackendExample_CIApp_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_NoiseBackendExample_IApp[] = L"NoiseBackendExample.IApp";

namespace NoiseBackendExample {
    /* [uuid("a2309d83-9606-57ab-a883-d9fb446e1582"), version, object, exclusiveto] */
    MIDL_INTERFACE("a2309d83-9606-57ab-a883-d9fb446e1582")
...
EXTERN_C const IID IID___x_NoiseBackendExample_CIApp;
#endif /* !defined(____x_NoiseBackendExample_CIApp_INTERFACE_DEFINED__) */


/*
 *
 * Class NoiseBackendExample.App
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    NoiseBackendExample.IApp ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_NoiseBackendExample_App_DEFINED
#define RUNTIMECLASS_NoiseBackendExample_App_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_NoiseBackendExample_App[] = L"NoiseBackendExample.App";
#endif
...
#ifndef ____x_NoiseBackendExample_CIApp_FWD_DEFINED__
#define ____x_NoiseBackendExample_CIApp_FWD_DEFINED__
typedef interface __x_NoiseBackendExample_CIApp __x_NoiseBackendExample_CIApp;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_NoiseBackendExample_IApp[] = L"NoiseBackendExample.IApp";
/* [uuid("a2309d83-9606-57ab-a883-d9fb446e1582"), version, object, exclusiveto] */
typedef struct __x_NoiseBackendExample_CIAppVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_NoiseBackendExample_CIApp * This,
...
} __x_NoiseBackendExample_CIAppVtbl;

interface __x_NoiseBackendExample_CIApp
{
    CONST_VTBL struct __x_NoiseBackendExample_CIAppVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_NoiseBackendExample_CIApp_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_NoiseBackendExample_CIApp_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_NoiseBackendExample_CIApp_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_NoiseBackendExample_CIApp_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_NoiseBackendExample_CIApp_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_NoiseBackendExample_CIApp_GetTrustLevel(This,trustLevel) \
