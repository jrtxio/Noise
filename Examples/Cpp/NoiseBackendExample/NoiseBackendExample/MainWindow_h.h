...
#ifndef ____x_NoiseBackendExample_CIMainWindow_FWD_DEFINED__
#define ____x_NoiseBackendExample_CIMainWindow_FWD_DEFINED__

namespace NoiseBackendExample {
    interface IMainWindow;
} /* NoiseBackendExample */
#define __x_NoiseBackendExample_CIMainWindow NoiseBackendExample::IMainWindow

#endif // ____x_NoiseBackendExample_CIMainWindow_FWD_DEFINED__
...
/*
 *
 * Interface NoiseBackendExample.IMainWindow
 *
 * Interface is a part of the implementation of type NoiseBackendExample.MainWindow
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: NoiseBackendExample.IMainWindow:
 *
 *
 */
#if !defined(____x_NoiseBackendExample_CIMainWindow_INTERFACE_DEFINED__)
#define ____x_NoiseBackendExample_CIMainWindow_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_NoiseBackendExample_IMainWindow[] = L"NoiseBackendExample.IMainWindow";

namespace NoiseBackendExample {
    /* [uuid("3ac222ee-328d-54b8-b74f-a95ae7928845"), version, object, exclusiveto] */
    MIDL_INTERFACE("3ac222ee-328d-54b8-b74f-a95ae7928845")
...
EXTERN_C const IID IID___x_NoiseBackendExample_CIMainWindow;
#endif /* !defined(____x_NoiseBackendExample_CIMainWindow_INTERFACE_DEFINED__) */


/*
 *
 * Class NoiseBackendExample.MainWindow
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    NoiseBackendExample.IMainWindow ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_NoiseBackendExample_MainWindow_DEFINED
#define RUNTIMECLASS_NoiseBackendExample_MainWindow_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_NoiseBackendExample_MainWindow[] = L"NoiseBackendExample.MainWindow";
#endif
...
#ifndef ____x_NoiseBackendExample_CIMainWindow_FWD_DEFINED__
#define ____x_NoiseBackendExample_CIMainWindow_FWD_DEFINED__
typedef interface __x_NoiseBackendExample_CIMainWindow __x_NoiseBackendExample_CIMainWindow;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_NoiseBackendExample_IMainWindow[] = L"NoiseBackendExample.IMainWindow";
/* [uuid("3ac222ee-328d-54b8-b74f-a95ae7928845"), version, object, exclusiveto] */
typedef struct __x_NoiseBackendExample_CIMainWindowVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_NoiseBackendExample_CIMainWindow * This,
...
} __x_NoiseBackendExample_CIMainWindowVtbl;

interface __x_NoiseBackendExample_CIMainWindow
{
    CONST_VTBL struct __x_NoiseBackendExample_CIMainWindowVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_NoiseBackendExample_CIMainWindow_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_NoiseBackendExample_CIMainWindow_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_NoiseBackendExample_CIMainWindow_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_NoiseBackendExample_CIMainWindow_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_NoiseBackendExample_CIMainWindow_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_NoiseBackendExample_CIMainWindow_GetTrustLevel(This,trustLevel) \
